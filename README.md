...
关于 `markdown 语法` 和在 `jupyter notebook` 及 `vscode 的 jupyter 插件` 目录跳转总结

| 目录跳转 | `[](#)` | <a href="#"></a>|
| --- | --- | --- |
| `markdown` | 短横线目录：带空格的标题；半角句号；中文 | 支持（标题中空格、半角句号、中文） |
| `jupyter notebook` | 短横线目录：带空格的标题；支持（半角句号、中文） | 支持（半角句号、中文）、不支持（标题中空格） |
| `vscode jupyter`   | 不支持                                           | 支持（中文）、不支持（标题中空格、半角句号） |
...
<a href="#没有空格的标题">没有空格的标题</a>
	## 没有空格的标题
<a href="#有空格 的标题">有空格 的标题</a>
	## 有空格 的标题
<a href="#有空格-的标题">有空格 的标题</a>
	## 有空格 的标题
<a href="#有半角句号.的标题">有半角句号.的标题</a>
	## 有半角句号.的标题
<a href="#1">Title</a>
	<a id="#1"></a>
```

可见 `Typora markdown` 的支持是十分齐全的
